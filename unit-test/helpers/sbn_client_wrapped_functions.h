...
CFE_SB_MsgId_t __real_CFE_SBN_Client_GetMsgId(CFE_MSG_Message_t *);
...
int __wrap_pthread_cond_timedwait(pthread_cond_t *, pthread_mutex_t *,
  const struct timespec *);
CFE_SB_MsgId_t __wrap_CFE_SBN_Client_GetMsgId(CFE_MSG_Message_t *);
...
extern bool use_wrap_ingest_app_message;
extern bool wrap_ingest_app_message_was_called;
extern int wrap_ingest_app_message_call_count;
extern bool use_wrap_CFE_SBN_Client_ReadBytes;
extern unsigned char *wrap_CFE_SBN_Client_ReadBytes_msg_buffer;
extern int wrap_CFE_SBN_Client_ReadBytes_return_value;
extern bool wrap_CFE_SBN_Client_ReadBytes_was_called;
extern int wrap_CFE_SBN_Client_ReadBytes_call_count;
extern bool wrap_pthread_mutex_lock_should_be_called;
extern bool wrap_pthread_mutex_lock_was_called;
extern int wrap_pthread_mutex_lock_return_value;
extern bool wrap_pthread_mutex_unlock_should_be_called;
extern bool wrap_pthread_mutex_unlock_was_called;
extern int wrap_pthread_mutex_unlock_return_value;
extern bool wrap_pthread_cond_signal_should_be_called;
extern bool wrap_pthread_cond_signal_was_called;
extern bool wrap_pthread_cond_wait_should_be_called;
extern bool wrap_pthread_cond_wait_was_called;
extern bool use_wrap_pthread_cond_wait;
extern int wrap_pthread_cond_wait_return_value;
extern bool use_wrap_CFE_SBN_Client_GetMsgId;
extern CFE_SB_MsgId_t wrap_CFE_SBN_Client_GetMsgId_return_value;
extern bool wrap_pthread_cond_timedwait_should_be_called;
extern bool use_wrap_pthread_cond_timedwait;
extern bool wrap_pthread_cond_timedwait_was_called;
extern int wrap_pthread_cond_timedwait_return_value;
extern bool use_wrap_CFE_SBN_Client_GetPipeIdx;
extern uint8 wrap_CFE_SBN_Client_GetPipeIdx_return_value;
extern bool use_wrap_connect_to_server;
extern int wrap_connect_to_server_return_value;
extern int wrap_exit_expected_status;  
extern bool use_wrap_CFE_SBN_Client_InitPipeTbl;
...
extern bool use_wrap_check_pthread_create_status;
extern bool wrap_check_pthread_create_status_fail_call;
extern uint8 check_pthread_create_status_call_number;
extern int check_pthread_create_status_errors_on_call_number;
extern bool use_wrap_send_heartbeat;
