...
# Some include files are now generated by cFS, so you need to include them from the build directory
CFE_INC = -I../../cfe/modules/core_api/fsw/inc -I../../cfe/modules/msg/fsw/inc -I../../build-sim/inc
OSAL_INC = -I../../osal/src/os/inc -I../../build-sim/native/default_cpu1/inc
